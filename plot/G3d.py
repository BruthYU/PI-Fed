...
z_along_x = line_fix_y(grad[0], point[0], z_0, point[0] + 1)
z_along_y = line_fix_x(grad[1], point[1], z_0, point[1] + 1)
...
ax1.arrow3D(point[0]-0.05, point[1]+0.05 , z_0,
              1, 0, z_along_x-z_0-0.05,
              mutation_scale=9,
              arrowstyle="simple",
              color = 'blue'
              )
